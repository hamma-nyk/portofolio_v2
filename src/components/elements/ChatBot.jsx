  ...
  return (
    <div className="fixed bottom-5 right-5 z-[100] flex flex-col items-end">
      ...
      <motion.button
        ...
        className="group relative flex items-center justify-center w-14 h-14 rounded-full bg-gradient-to-br from-blue-600 to-purple-600 shadow-lg shadow-neutral-900 text-white overflow-hidden"
      >
