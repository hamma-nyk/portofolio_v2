      ...
      >
        <div className="flex flex-col h-full px-2 sm:px-10 w-full items-start justify-center">
          ...
          <div className="flex flex-wrap w-full gap-4 mt-6 mx-auto justify-center">
            <div className="flex flex-col max-w-md mx-2 sm:max-w-lg rounded-xl overflow-hidden shadow-lg border border-neutral-700 bg-neutral-700/60 backdrop-blur shadow-md hover:-translate-y-[2px] duration-300 transition ease-in-out">
